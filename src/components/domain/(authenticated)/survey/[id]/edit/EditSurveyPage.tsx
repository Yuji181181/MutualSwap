...
import { SurveyFormSkeleton } from "@/components/domain/(authenticated)/survey/new/SurveyFormSkeleton";
...
import { useEditSurveyPage } from "@/hooks/domain/(authenticated)/survey/[id]/edit/useEditSurveyPage";
